...
INSERT INTO roles (id, name, description, permissions, access_level) VALUES
...
BEGIN
  ...
  -- Insert role assignment using explicit role ID
...
INSERT INTO user_roles (user_id, role_id)
SELECT 'efbd2fb4-4a3b-4d6e-a553-eec02a567ba8', id
FROM roles
WHERE name = 'member'
