...
DROP INDEX IF EXISTS idx_care_team_profile_id;
DROP INDEX IF EXISTS idx_care_team_partner_id;
DROP INDEX IF EXISTS idx_care_team_pharmacy_id;
DROP INDEX IF EXISTS idx_care_team_relationship;
DROP INDEX IF EXISTS care_team_profile_idx;
DROP INDEX IF EXISTS care_team_partner_idx;
DROP INDEX IF EXISTS care_team_pharmacy_idx;
DROP INDEX IF EXISTS care_team_relationship_idx;
...
(
  ...
  '(415) 555-0123',
  'pharmacy2@healthcarepharmacy.com',
