/*
  ...
  1. Changes
    ...
    - Allow authenticated users to claim active promotions
    - Ensure users can only claim promotions for themselves
    - Allow partners to manage claims for their promotions

  2. Security
    - Enable RLS
    - Add policies for:
      - SELECT: Users can see their own claims, partners see claims for their promotions
      - INSERT: Users can claim active promotions for themselves
