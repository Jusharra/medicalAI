/*
  # Create Leads and Related Tables with Fixed Policies

  1. New Tables
    - `leads` - Stores lead information
    - `lead_interactions` - Tracks interactions with leads
    - `lead_assignments` - Manages partner assignments to leads
...
-- Create lead_assignments table for partner assignments
...
-- Enable RLS for lead_assignments
