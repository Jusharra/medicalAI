/*
  ...
  1. Changes
    ...
    - Fix foreign key relationships for logs table
...
CREATE POLICY IF NOT EXISTS "Admins can access logs"
  ON logs
  FOR ALL
  TO authenticated
  USING ((auth.jwt() ->> 'role')::text = 'admin');

CREATE POLICY IF NOT EXISTS "Allow all inserts for logging"
  ON logs
  FOR INSERT
